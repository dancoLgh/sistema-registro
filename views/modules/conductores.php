    ...
    <div class="row color-gris">
        <div class="col panel panel-primary filterable">
            <div class="panel-heading">
                <h3 class="panel-title text-center display-4 mt-5 ">Conductores Registrados</h3>
...
?>
            ...
            <table class="table table-primary table-hover text-center table-sm table-responsive ">
                <thead >
                    <tr class=" filters">           
                        <th><input type="text" class="form-control text-center" placeholder="Nombres" disabled></th>
                        <th><input type="text" class="form-control text-center" placeholder="Apellido Paterno" disabled></th>
                        <th><input type="text" class="form-control text-center" placeholder="Apellido Materno" disabled></th>
                        <th><input type="text" class="form-control text-center" placeholder="Numero de documento" disabled></th>
                ...
                <tbody>
                    <?php 
						...
						$vista -> vistaConductorController();
					//	$vista -> borrarConductorController();
		 				?>
                </tbody>
            </table>
        </div>
